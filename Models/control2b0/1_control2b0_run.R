...
# theta is ( 1-S_0, 2-rho, 3-psi, 4-b0G, 5-b0H, 6-b1, 7-b2, 8-eta, 9-muG, 10-epsilon )

theta.lo = replace(theta, c(2,3,4,5,6,8,9,10), c(0,0,0,0,0,0, 0,0))
theta.hi = replace(theta, c(2,3,4,5,6,8,9,10), c(1,1,1,1,1,6,10,1))
